...
<body>
    ...
    <main>
        ...
        <article>
            <h1 class="text-center fs-1 mt-3">RECEPTIONIST <spand class="text-warning">DASHBOARD</span></h1>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="ms-2 c-details">
                                        <h6 class="mb-0">Patient</h6> <span>1 days ago</span>
                                    </div>
                                </div>
                        ...
                        <div class="card p-3 m-3">
                            <div class="d-flex justify-content-between">
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="ms-2 c-details">
                                        <h6 class="mb-0">Verify</h6> <span>4 days ago</span>
                                    </div>
                                </div>
                                <div class="badge"> <span>Recently Added</span> </div>
                            </div>
                            <div class="mt-5">
                                <h3 class="heading">Report/Bills Verify</h3>
                                <div class="mt-5">
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                            ...
                            <div class="card p-3 m-3">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-2 c-details">
                                            <h6 class="mb-0">Appointment</h6> <span>2 days ago</span>
                                        </div>
                                    </div>
                                    <div class="badge"> <span>Recently Added</span> </div>
                                </div>
                                <div class="mt-5">
                                    <h3 class="heading">Appointment Module</h3>
                                    <div class="mt-5">
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
            ...
            <script>
                ...
                greeting = 'Welcome! ' ; }
                document.write("<h4 class='text-center m-5'><span class='text-warning'>"+ greeting +"</span> RECEPTIONIST<h4>");
            </script>
        </article>
