                    ...
                    <form action="" method="post" class="w-75">
                        <div class="row pt-2">
                            <div class="col-md col-lg-4">
                                <?php inputElement("<i class='fas fa-id-card'></i>", "ID", "pid", setID()); ?>
                            </div>
                            <div class="col-md col-lg-8">
                                <?php inputElement("<i class='fas fa-file-signature'></i>", "Name", "pname", ""); ?>
                            </div>
                        </div>
                        <div class="pt-2">
                        ...
                        <div class="row pt-2">
                            <div class="col-md">
                                <?php inputElement("<i class='fas fa-calendar-alt'></i>", "DOB : YYYY-MM-DD", "dob", ""); ?>
                            </div>
                            <div class="col-md">
                        ...
                        <div class="row pt-2">
                            <div class="col-md">
                                <?php inputElement("<i class='fas fa-flask'></i>", "Blood Group", "blood", ""); ?>
                            </div>
                            <div class="col-md">
                                <?php inputElement("<i class='fas fa-dollar-sign'></i>", "Gender", "gender", ""); ?>
                            </div>
                        </div>
